...
function setBotResponse(response) {
    ...
    setTimeout(function() {
        ...
        if (response.length < 1) {
            ...
            var BotResponse = '<img class="botAvatar" src="./static/img/favicon.png"/><p class="botMsg">' + fallbackMsg + '</p><div class="clearfix"></div>';
            ...
            for (i = 0; i < response.length; i++) {
                ...
                if (response[i].hasOwnProperty("text")) {
                    var BotResponse = '<img class="botAvatar" src="./static/img/favicon.png"/><p class="botMsg">' + response[i].text + '</p><div class="clearfix"></div>';
                    $(BotResponse).appendTo(".chats").hide().fadeIn(1000);
                }
...
$('#maximize').click(function(){
        ...
        if($this.hasClass('max')){
            $this.html('<div class="max" id="#maximize">Maximize</div>');
            $(".widget").css({
                position: '',
                top: '',
                right: '',
        ...
        {
            $this.html('<div class="min" id="#minimize">Minimize</div>');
            $(".widget").css({
                position: 'fixed',
                right: '15px',
                bottom: '1%',
...
//==========================Microphone colour change on click=====================
...
function showBotTyping() {
    ...
    var botTyping = '<img class="botAvatar" id="botAvatar" src="./static/img/favicon.png"/><div class="botTyping">' + '<div class="bounce1"></div>' + '<div class="bounce2"></div>' + '<div class="bounce3"></div>' + '</div>'
